...
public class StoreController {
    ...
    /**
     * Displays a JSON array of high level categories for baked goods
     * and customers,each with links to more detailed end points
    ...
    /**
     * Reads a JSON object and deserializes into a BakedItem POJO
    ...
    /**
     * Reads a JSON object and deserializes into a customer
     * for storage purposes
