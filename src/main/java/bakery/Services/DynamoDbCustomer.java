...
class DynamoDbCustomer {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DynamoDbCustomer.class);
	...
	@Autowired
	private DynamoDbCustomer(DynamoSecurity secureDb) {
	...
	void addAvailableBakedGoods(BakedGoods item) throws JsonProcessingException {
